...
class MyGUI(QMainWindow):
    ...
    def on_click(self):
        m = multiprocessing.Process(target=self.concatenate_videos())
        m.start()
        m.join()
    ...
    def concatenate_videos(self):
        ...
        try:
            ...
            self.videoInfos.setText("Videos concatenated and saved as \n"+output_file.replace('\\',"/"))
        except ffmpeg.Error as e:
            self.videoInfos.setText("Error concatenating videos: "+str(e))
        self.setStatusInterface(True)
